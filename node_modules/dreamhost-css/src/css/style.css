...
code { padding: 0 0.5rem; font-size: 0.875rem; display: inline-block; border: 1px solid #F4F6F9; border-radius: 3px; background: #434F58; color: #ffffff; font-family: monospace; }
...
.Card__large-icon ~ .Card__super { position: absolute; top: 2.5rem; left: 6.25rem; text-transform: uppercase; font-size: 0.875rem; color: #677983; }
...
.Tabs ul { border-bottom: solid 1px #F4F6F9; font-size: 0; }
...
.Tabs__nav-item:hover, .Tabs__nav-item:active { color: #071c26; }
...
*/
.Tag { text-transform: uppercase; display: inline-block; font-weight: bold; font-size: 0.75em; border-radius: 20px; padding: 0.25em 0.75em 0.05em; }
...
*/
.PageHeader { padding: 1.75rem 4rem; background: #071c26; color: #fff; }
...
.PageHeader__nav-link { text-decoration: none; font-weight: 600; color: #E0E4E8; font-size: 0.875rem; display: inline-block; outline: none; position: relative; }
...
.PageHeader__subnav .PageHeader__subnav svg { height: 100%; width: 100%; }
...
.PageHeader__notification-amount { display: inline-block; background: #FF4A48; padding: 1px 4px; border-radius: 50px; width: 1rem; height: 1rem; font-weight: 600; text-align: center; vertical-align: middle; transform: translate(18px, -4px); }
