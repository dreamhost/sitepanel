...
.List__menu--title { text-transform: uppercase; letter-spacing: .666px; color: #434F58; font-size: 0.875rem; margin-bottom: 0.5rem; }
...
.PageHeader__subnav svg { height: 100%; width: 100%; }
